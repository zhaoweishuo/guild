...
* 附魔要求 进本附魔不全者 EP减半 丧失装备需求权(只允许贪婪)
    ...
    * 披风	70护甲/3敏捷/5全抗(p5阶段以后增加要求 15自然抗/-2仇恨/1闪避)
    * 胸	4全属性/3全属性/100法力值/100生命值			
    * 腕	24治疗效果/9耐力/9力量/7智力/4五回			
    * 手	7力量/7敏捷/1攻速(p5阶段以后要增加 20法伤/30治疗/2仇恨/15敏捷)
    * 脚	7敏捷/7耐力/5精神/移速
...
* 道具要求
    * 一些特定的boss如维希度斯需要全员工程炸弹或者<del>爆炸水晶</del>(爆炸水晶显示免疫字样 是否产生伤害待定)，提前要求不准备者当前boss EP取消 丧失装备需求权
...
* 活动第五周开始，新入团人员，两个cd全勤后可以需求非极品套装散件 ，四个cd可以正常需求
